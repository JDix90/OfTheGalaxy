...
const SUBMAPS = {
  medical_center: {
    ...
    layoutData: {
      ...
      zones: [
        { id: 'z_rec', name: 'Reception', type: 'reception', bounds: { x: 0, y: 5, width: 4, height: 3 } },
        { id: 'z_treat', name: 'Treatment Wing', type: 'wing', bounds: { x: 0, y: 0, width: 7, height: 4 } },
        { id: 'z_surg', name: 'Surgery', type: 'wing', bounds: { x: 7, y: 0, width: 5, height: 4 } },
        { id: 'z_ward', name: 'Patient Ward', type: 'wing', bounds: { x: 0, y: 8, width: 12, height: 4 } },
      ],
  ...
  spaceport: {
    ...
    layoutData: {
      ...
      zones: [
        { id: 'z_term', name: 'Terminal', type: 'terminal', bounds: { x: 4, y: 0, width: 4, height: 3 } },
        { id: 'z_hangar', name: 'Hangar Bay', type: 'hangar', bounds: { x: 0, y: 7, width: 5, height: 5 } },
        { id: 'z_pads', name: 'Landing Pads', type: 'pad', bounds: { x: 1, y: 1, width: 3, height: 3 } },
      ],
