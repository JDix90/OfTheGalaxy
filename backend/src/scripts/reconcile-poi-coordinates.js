...
const POI_COORDINATES = {
  dantooine: [
    { id: 'jedi_enclave_ruins', name: 'Jedi Enclave Ruins', x: 500, y: 500 },
    { id: 'kinrath_cave', name: 'Kinrath Cave', x: 200, y: 800 },
  ...
  ryloth: [
    { id: 'lessu', name: 'Lessu (Capital City)', x: 500, y: 500 },
    { id: 'bright_lands', name: 'The Bright Lands', x: 800, y: 500 },
    { id: 'nightlands', name: 'The Nightlands', x: 200, y: 500 },
    { id: 'twilek_resistance_base', name: "Twi'lek Resistance Base", x: 400, y: 600 },
    { id: 'imperial_garrison', name: 'Imperial Garrison', x: 600, y: 400 }
  ],
  chandrila: [
    ...
    { id: 'new_republic_senate', name: 'New Republic Senate Building', x: 850, y: 400 }
  ],
  eriadu: [
    { id: 'eriadu_city', name: 'Eriadu City', x: 950, y: 500 },
    { id: 'tarkin_estate', name: 'The Tarkin Estate', x: 700, y: 300 },
  ...
  nar_shaddaa: [
    ...
    { id: 'hutt_palace', name: 'The Hutt Cartel Palace', x: 500, y: 500 },
  ...
  dathomir: [
    ...
    { id: 'rancor_graveyard', name: 'The Rancor Graveyard', x: 800, y: 200 },
    { id: 'singing_mountain_clan', name: "Singing Mountain Clan Village", x: 200, y: 800 },
    { id: 'cursed_swamp', name: 'The Cursed Swamp', x: 100, y: 100 }
  ],
  tatooine: [
    { id: 'mos_eisley', name: 'Mos Eisley Spaceport', x: 400, y: 600 },
    { id: 'mos_espa', name: 'Mos Espa', x: 300, y: 300 },
    { id: 'jabbas_palace', name: "Jabba's Palace", x: 700, y: 200 },
    { id: 'krayt_dragon_graveyard', name: 'Krayt Dragon Graveyard', x: 800, y: 800 },
    { id: 'jundland_wastes', name: 'Jundland Wastes', x: 200, y: 500 },
    { id: 'anchorhead', name: 'Anchorhead', x: 500, y: 700 }
  ],
  coruscant: [
    { id: 'new_republic_senate', name: 'New Republic Senate Building', x: 500, y: 500 },
    { id: 'jedi_temple_ruins', name: 'The Jedi Temple (Ruined)', x: 400, y: 400 },
    { id: 'underworld', name: 'The Underworld', x: 200, y: 975 },
    { id: 'imperial_palace', name: 'The Imperial Palace', x: 600, y: 300 },
  ...
  kashyyyk: [
    ...
    { id: 'rwookrrorro', name: 'Rwookrrorro (Wookiee Village)', x: 300, y: 400 },
  ...
  mon_cala: [
    ...
    { id: 'quarren_base', name: 'Quarren Isolation League Base', x: 100, y: 100 }
  ],
  mustafar: [
    { id: 'mining_facility', name: 'The Mining Facility', x: 850, y: 800 },
    { id: 'vaders_castle', name: "Vader's Castle", x: 800, y: 200 },
  ...
  felucia: [
    ...
    { id: 'ancient_sith_temple', name: 'The Ancient Sith Temple', x: 800, y: 900 },
    { id: 'rancor_den', name: 'The Rancor Den', x: 100, y: 100 }
  ],
  ord_mantell: [
    { id: 'worlport', name: 'Worlport', x: 800, y: 850 },
    { id: 'scrapyard', name: 'The Scrapyard', x: 500, y: 500 },
    { id: 'black_sun_hideout', name: 'The Black Sun Hideout', x: 800, y: 200 },
  ...
  kuat: [
    ...
    { id: 'resistance_safehouse', name: 'The Resistance Safehouse', x: 200, y: 900 },
    { id: 'abandoned_orbital_prison', name: 'The Abandoned Orbital Prison', x: 100, y: 100 }
  ],
  bothawui: [
    { id: 'bothan_spynet_hq', name: 'The Bothan Spynet Headquarters', x: 500, y: 200 },
    { id: 'black_sun_embassy', name: 'The Black Sun Embassy', x: 800, y: 800 },
    { id: 'ancient_bothan_temple', name: 'The Ancient Bothan Temple', x: 200, y: 800 },
    { id: 'shadow_market', name: 'The Shadow Market', x: 100, y: 100 }
  ],
  corellia: [
    { id: 'coronet_spaceport', name: 'The Coronet City Spaceport', x: 500, y: 200 },
    { id: 'black_sun_hq', name: 'The Black Sun Headquarters', x: 800, y: 800 },
  ...
  yavin4: [
    ...
    { id: 'dark_side_cave', name: 'The Dark Side Cave', x: 100, y: 100 }
  ],
  hoth: [
  ...
  mandalore: [
    ...
    { id: 'mines_mandalore', name: 'The Mines of Mandalore', x: 900, y: 875 },
    { id: 'great_forge', name: 'The Great Forge', x: 800, y: 200 },
    { id: 'tomb_mandalore_great', name: 'The Tomb of Mandalore the Great', x: 100, y: 100 }
  ]
};
